...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      bgGradient: 'from-cyan-500/20 to-blue-500/20',
      titleColor: 'text-cyan-400',
      description: 'A modern, responsive, and dynamic web application built with React to help dropshippers calculate and visualize their true Net Margins based on real-world variables like expected order count, delivery rates, and ad spends.',
      techs: ['React', 'Chartjs', 'Tailwind Css', 'Framer-Motion', 'Hero-icon'],
